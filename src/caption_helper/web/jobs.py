...
class JobRunner:
    ...
    def __init__(self, store: ProjectStore) -> None:
        ...
        self._glm_tts_engine: GLMTTSEngine | None = None
    ...
    def tts_model_id(self, *, provider: str = "moss-tts") -> str:
        if provider == "glm-tts":
            return self._glm_tts_config.model
    ...
    def _get_tts_engine(self, provider: str = "moss-tts"):
        if provider == "glm-tts":
            if self._glm_tts_engine is None:
                self._glm_tts_engine = GLMTTSEngine(self._glm_tts_config)
            return self._glm_tts_engine
    ...
    def _run_synthesis(self, project_id: str) -> None:
        ...
        model_id = self.tts_model_id(provider=provider)
        ...
        try:
            ...
            result = synthesize_modified_segments(
                project_dir,
                engine=self._get_tts_engine(provider),
